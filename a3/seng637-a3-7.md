...
| Test Case | Execution Path | DU Pairs |
| --------- | -------------- | -------- |
| Equal lower and upper value | Bypass `if` (Path 1->2->5) | None |
...
| Test Case | Execution Path | DU Pairs |
| --------- | -------------- | -------- |
| Negative lower and upper value | Bypass `if` (Path 1->2->5) | None |
...
| Test Case | Execution Path | DU Pairs |
| --------- | -------------- | -------- |
| NaN lower value | Enter `if` (Path 1->2->3->4) | (NaN, lower) |
