...
Given the constructor's constraints, the `getLowerBound` method does not include any conditional logic related to the validity of the range; hence, no tests for invalid range creation are required or possible through this method.
